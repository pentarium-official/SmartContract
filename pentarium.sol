...
// Pentarium - PTM // FEEL THE PENTA POWER 

   //https://t.me/pentarium
   //https://pentarium.org
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x56f945A1151385f0ea3c818591443162C5ccE119;
...
contract Pentarium is Context, IERC20, Ownable { 
    using SafeMath for uint256;
    using Address for address;


    // Pentarium Tracking status of wallets
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    // Pentarium Blacklist: If 'noBlackList' is true wallets on this list can not buy - used for known bots
    mapping (address => bool) public _isBlacklisted;

    // Pentarium Set contract so that blacklisted wallets cannot buy (default is false)
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x56f945A1151385f0ea3c818591443162C5ccE119);
    ...
    Pentarium TOKEN DETAILS

    */


    string private _name = "Pentarium"; 
    string private _symbol = "PTM";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _tFeeTotal;

    // Pentarium Counter for liquify trigger
    uint8 private txCount = 0;
    uint8 private swapTrigger = 3; 

    // This is the max fee that the Pentarium contract will accept, it is hard-coded to protect buyers
    // This includes the buy AND the sell fee!
    uint256 private maxPossibleFee = 24; 


    // Setting the Pentarium initial fees
    ...
    */
    ...
    DEPLOY TOKENS TO Pentarium OWNER
    ...
    */
    ...
    // Update main wallet
    function PENTARIUM_Update_Wallet(address payable wallet) public onlyOwner() {
        Wallet_Dev = wallet;
        _isExcludedFromFee[Wallet_Dev] = true;
    }
    ...
    */
    ...
    // Pentarium Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
